...
class FitResultDataTable(wx.grid.PyGridTableBase, Subject):
    ...
    def __init__(self):
        ...
        rowlist=[
            ...
            'N Sr',      'double_empty:4,1', 0, 1, 'Sr', #2
            'Nerr Sr',   'double_empty:4,2', 0, 0, 'Sr',
            'Nth Sr',    'double_empty:4,1', 0, 0, 'Sr', #3
            'Nbec Sr',   'double_empty:4,1', 0, 0, 'Sr', #4
            'OD Sr',     'double_empty:4,1', 0, 1, 'Sr', #5
            'sx Sr',     'double_empty:4,1', 0, 1, 'Sr', #6
            'sxerr Sr',  'double_empty:4,2', 0, 0, 'Sr', #7
            'sy Sr',     'double_empty:4,1', 0, 1, 'Sr', #8
            'syerr Sr',  'double_empty:4,2', 0, 0, 'Sr', #9
            'rx Sr',     'double_empty:4,1', 0, 0, 'Sr', #10
            'rxerr Sr',  'double_empty:4,2', 0, 0, 'Sr', #11
            'ry Sr',     'double_empty:4,1', 0, 0, 'Sr', #12
            'ryerr Sr',  'double_empty:4,2', 0, 0, 'Sr', #13
            'mx Sr',     'double_empty:4,1', 0, 0, 'Sr', #14
            'myerr Sr',  'double_empty:4,2', 0, 0, 'Sr', #15
            'my Sr',     'double_empty:4,1', 0, 0, 'Sr', #16
            'myerr Sr',  'double_empty:4,2', 0, 0, 'Sr', #17
            'T Sr',      'double_empty:4,3', 0, 1, 'Sr', #18
            'Terr Sr',   'double_empty:4,3', 0, 0, 'Sr', #19
            'sigma Sr',  'double_empty:4,3', 0, 0, 'Sr',
            'params Sr', 'string',           0, 0, 'Sr', #20
            'Angle Sr', 'double_empty:4,3', 0, 0, 'Sr',
            'N K',      'double_empty:4,1', 0, 1, 'K', #2
            'Nerr K',   'double_empty:4,2', 0, 0, 'K',
            'Nth K',    'double_empty:4,1', 0, 0, 'K', #3
            'Nbec K',   'double_empty:4,1', 0, 0, 'K', #4
            'OD K',     'double_empty:4,1', 0, 1, 'K', #5
            ...
            'Angle K', 'double_empty:4,3', 0, 0, 'K',            
            ...
            'OD Rb',    'double_empty:4,1', 0, 1, 'Rb',#24
            ...
            'Angle Rb', 'double_empty:4,3', 0, 0, 'Rb',
            'OD2 Rb',   'double_empty:4,3', 0, 0, 'Rb',
            'OD2err Rb','double_empty:4,3', 0, 0, 'Rb',
            'sx2 Rb',   'double_empty:4,1', 0, 0, 'Rb',#26
            'sx2err Rb','double_empty:4,2', 0, 0, 'Rb',#27
            'sy2 Rb',   'double_empty:4,1', 0, 0, 'Rb',#26
            'syerr Rb', 'double_empty:4,2', 0, 0, 'Rb',#29
            'N2 Rb',    'double_empty:4,1', 0, 0, 'Rb',#21
            'N2err Rb', 'double_empty:4,2', 0, 0, 'Rb',#21
            'params Rb','string',           0, 0, 'Rb',#40
            'N total', 'double_empty: 4,3', 1, 1, '', # (jsc)
            'm',       'double_empty: 4,3', 1, 1, '', # (jsc)
            'rho Sr',  'double_empty: 4,3', 1, 1, '', # (jsc)
            'rho K',   'double_empty: 4,3', 1, 1, '', # (jsc)
            'rho Rb',  'double_empty: 4,3', 1, 1, '', # (jsc)
            ...
            'dynamic 5','double_empty:5,3', 1, 0, '',  
            'dynamic 6','double_empty:5,3', 1, 0, '',  
            'dynamic 7','double_empty:5,3', 1, 0, '',  
