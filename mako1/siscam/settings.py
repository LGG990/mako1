...
varfile = os.path.join('C:/Users/Lab/Desktop', 'Variables.txt')

#os.path.join('//epsc01fs21/home29/X/XXW513/share', 'Variables.txt')
...
#change imgfilepath to Public folder on other PC
#imagefile = r"W:/ocf/fit.sis" #direct access to acquired image on camera computer

#path where to save images
imagesavepath = 'C:\CamData'
#'\\epsfs3\PHYcold\Open\Projects\Disorder\newcamera\siscam\img' #with subdirs automagically created
